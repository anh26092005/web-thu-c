...
<Image 
    ...
    <p className="text-shop_light_green text-xs xs:text-sm text-center font-bold">Tra cứu nguồn gốc xuất xứ hàng hóa <a href="https://dichvucong.dav.gov.vn/congbothuoc/index" className=" ml-1 text-shop_light_green underline" target="_blank" rel="noopener noreferrer">Kiểm tra ngay</a></p>
      <div className="md:hidden flex items-center px-5 mt-5 w-full justify-between" >
           <div className="relative right-0">
           <MobileMenu/>
           </div>
           <Logo className="mx-auto text-xl"/> 
           <CartIcon/>
           {/* Đã chuyển user button, wishlist và orders sang sidebar */}
      </div>
      <Container className="flex items-center justify-between text-lightColor mt-5 relative">
        ...
        {/* <div className="w-auto md:w-2/3 flex items-center justify-end gap-5"> */}
          ...
          {user && (
            <Link
            href={"/orders"}
            className="group relative hover:text-shop_light_green hoverEffect mt-1 max-md:hidden"
            >
              <Logs />
